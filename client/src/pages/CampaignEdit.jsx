...
export default function CampaignEdit() {
    ...
    async function load() {
      ...
      try {
        ...
        body.deliverables = Array.isArray(body.deliverables)
          ...
          : body.deliverables || "";
        body.orderFormFields = Array.isArray(body.orderFormFields)
          ? body.orderFormFields.join(", ")
          : body.orderFormFields || "";
        // --- END NORMALIZATION ---
    ...
    try {
      const payload = {
        ...
        deliverables: campaign.deliverables
          ? String(campaign.deliverables)
              .split(",")
              .map((s) => s.trim())
              .filter(Boolean)
          : undefined,
        orderFormFields: campaign.orderFormFields
          ? String(campaign.orderFormFields)
              .split(",")
              .map((s) => s.trim())
              .filter(Boolean)
          : undefined,
  ...
  if (loading)
    return <div className="p-6 text-gray-400">Loading campaign details...</div>;
  if (!campaign)
    return (
      <div className="p-6 text-rose-400">
        No campaign found or unauthorized access.
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-12">
        ...
        <h1 className="text-3xl font-extrabold text-cyan-400 mb-6">
          <FaEdit className="inline mr-2" /> Edit Campaign:{" "}
        ...
        >
          ...
          <section className="space-y-4">
            ...
            <StyledInput
              ...
              onChange={handleCampaignChange("brandName")}
              placeholder="Brand Name"
              disabled
            />{" "}
            {/* Brand name often disabled after creation */}
            <StyledInput
              required
              value={campaign.category}
              onChange={handleCampaignChange("category")}
          ...
          <section className="space-y-4 pt-4 border-t border-gray-700/50">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <StyledInput
                  ...
                  onChange={handleCampaignChange("followersMin", true)}
              ...
              <div className="space-y-1">
                ...
                <StyledInput
                  ...
                  onChange={handleCampaignChange("followersMax", true)}
            ...
            <div className="space-y-1">
              ...
              <StyledInput
                ...
                onChange={handleCampaignChange("location")}
            ...
            <div className="space-y-1">
              ...
              <StyledTextarea
                ...
                onChange={handleCampaignChange("requirements")}
                placeholder="Detailed requirements (e.g. Make a 30s reel around the product...)"
                rows={3}
              />
            </div>
          </section>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <StyledInput
                  ...
                  onChange={handleCampaignChange("budget", true)}
              ...
              <div className="space-y-1">
                ...
                <StyledInput
                  ...
                  onChange={handleCampaignChange("deliverables")}
          ...
          <section className="space-y-4 pt-4 border-t border-gray-700/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <StyledSelect
                  ...
                  onChange={handleCampaignChange("fulfillmentMethod")}
                >
              ...
              <div className="space-y-1">
                ...
                <StyledSelect
                  ...
                  onChange={handleCampaignChange("payoutRelease")}
                >
            ...
            <div className="space-y-1">
              ...
              <StyledInput
                value={campaign.orderFormFields}
                onChange={handleCampaignChange("orderFormFields")}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <StyledInput
                  ...
                  onChange={handleCampaignChange("influencerComment")}
              ...
              <div className="space-y-1">
                ...
                <StyledInput
                  ...
                  onChange={handleCampaignChange("adminComment")}
                ...
                <span className="text-sm font-medium">
                  ...
                  {!campaign.isPublic ? (
                    <span className="text-emerald-400 ml-2 flex items-center gap-1">
                      <FaLockOpen /> (Visible to all creators)
                    </span>
                  ) : (
                    <span className="text-rose-400 ml-2 flex items-center gap-1">
                      <FaLock /> (Private/Draft)
                    </span>
                  )}
                </span>
              </label>
          ...
          >
            <Button
              ...
              disabled={saving}
              variant="primary"
              className="flex-1 text-lg shadow-lg hover:shadow-cyan-500/50"
            >
              {saving ? (
                "Saving Changes..."
              ) : (
