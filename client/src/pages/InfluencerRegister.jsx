...
import { motion as Motion } from "framer-motion"; // Import motion for animations (aliased to satisfy lint rules)
import {
  PLATFORM_OPTIONS,
  PLATFORM_META,
  isValidUrl,
...
export default function InfluencerRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast?.add("Account created — welcome to 1TO7MEDIA! 🎉", {
        type: "success",
      });
      ...
      >
        <header className="text-center mb-8">
          <h2 className="text-4xl font-extrabold text-white">
            Join the <span className="text-cyan-400">1TO7MEDIA</span> Creator
            Network
          </h2>
          <p className="text-sm text-gray-400 mt-2">
            Sign up now to discover top campaigns, manage collaborations, and
            grow your revenue.
          </p>
        </header>
        ...
        >
          ...
          <div className="col-span-2">
            <h3 className="text-xl font-semibold border-b border-gray-700/50 pb-2 mb-4 text-purple-400">
              Account Details
            </h3>
          </div>
          <StyledInput
          ...
          >
            ...
            <option value="nonbinary" className="bg-gray-700">
              Non-binary
            </option>
          ...
          <StyledInput
            ...
            placeholder="Total Followers Count (optional)"
            type="number"
            min="0"
          />
          ...
          <div className="col-span-2">
            <div className="text-sm text-gray-300 font-medium mb-2">
              Content Categories{" "}
              <span className="text-gray-500">(select up to 2)</span>
            </div>
          ...
          <div className="col-span-2">
            <div className="text-sm text-gray-300 font-medium mb-2">
              Content Languages{" "}
              <span className="text-gray-500">(select up to 3)</span>
            </div>
            <div className="flex flex-wrap gap-3">
          ...
          <div className="col-span-2">
            <div className="text-sm text-gray-300 font-medium mb-2">
              Social Platforms{" "}
              <span className="text-gray-500">(provide URL for selected)</span>
            </div>
              ...
              {PLATFORM_OPTIONS.map((p, index) => (
                <Motion.div
                  ...
                  className={`p-3 rounded-lg border transition duration-200 ${
                    platformChecks[p]
                      ? "border-cyan-400/50 bg-gray-700/50"
                    ...
                    <div className="mt-3">
                      <StyledInput
                        ...
                        className={`w-full text-sm ${
                          platformErrors[p] ? "border-rose-500" : ""
                        }`}
                      />
          ...
          <div className="col-span-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {COLLAB_OPTIONS.map((c) => (
                <Motion.label
                  key={c}
                  className={`flex items-center gap-2 p-2 rounded-lg cursor-pointer transition duration-200 text-sm ${
                    selectedCollabs.has(c)
                      ? "bg-purple-600/70"
          ...
          <div className="col-span-2 mt-6">
            ...
            >
              {loading
                ? "Creating Account..."
                : "Register and Launch Your Profile"}
            </Button>
